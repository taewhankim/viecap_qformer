...
OTHER_ARGS=$3
EPOCH=$4
WEIGHT_PATH=/data/twkim/viecap/checkpoints/$EXP_NAME/coco_prefix-00${EPOCH}.pt
COCO_OUT_PATH=/data/twkim/viecap/checkpoints/$EXP_NAME
...
--path_of_val_datasets /data/twkim/viecap/ann/coco/test_captions.json \
...
echo "==========================COCO EVAL================================"
python evaluation/cocoeval.py --result_file_path $COCO_OUT_PATH/coco*_${EPOCH}.json |& tee -a  ${COCO_LOG_FILE}